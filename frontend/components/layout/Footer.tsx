      ...
      <div className="shell">
        ...
        <div className={styles.bottom}>
          ...
          {/* Сведения об обработке данных должны быть легко доступны с любой
              страницы. Согласие, политика и пользовательское соглашение —
              самостоятельные документы и не подменяют друг друга. */}
          <ul className={styles.legal}>
            ...
            <li>
              <Link href="/legal/consent" className={styles.legalLink}>
                Согласие на ПДн
              </Link>
            </li>
            <li>
