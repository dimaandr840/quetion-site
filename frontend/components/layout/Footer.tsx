    ...
    <footer className={styles.footer}>
      <div className="shell">
        ...
        <div className={styles.bottom}>
          ...
          {/* Сведения об обработке данных должны быть легко доступны с любой
              страницы (ст. 13 GDPR, ст. 18.1 152-ФЗ), поэтому ссылки живут в
              подвале — рядом с возможностью отозвать согласие на cookie.
              Пользовательское соглашение — отдельный документ: согласие на
              обработку ПДн нельзя совмещать с ним в одном тексте. */}
