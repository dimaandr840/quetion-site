 ...
 *
 * Экран сознательно не показывает адрес получателя и даже его маску: сервер их не
 * отдаёт. Формулировки подобраны так, чтобы по тексту было нельзя понять, зарегистрирован
 * ли введённый адрес.
 */
        ...
        {step === "request" && (
          <>
            ...
            <p className={styles.subtitle}>
              Укажите адрес почты аккаунта. Если такой аккаунт существует, на его
              почту придёт одноразовый код. Сам адрес не показывается и не
              подсказывается.
            </p>
        ...
        {step === "confirm" && (
          <>
            ...
            <p className={styles.subtitle}>
              ...
              Проверьте свой ящик и введите код вида XXXX-XXXX.
              {expiresInMinutes
            ...
            <form className={styles.form} onSubmit={onConfirm}>
              ...
              <div className={styles.group}>
                ...
                <span className={styles.hint}>
                  Минимум {MIN_PASSWORD_LENGTH} символов. После сброса все активные
                  сессии завершатся, и понадобится войти заново.
                </span>
              </div>
