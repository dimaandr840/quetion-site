 ...
 * /legal/*, которые раньше падали на пререндере с ECONNREFUSED и обрывали сборку.
 * Поэтому рендерим по запросу, как и остальные страницы с данными.
...
export default async function PublicLayout({
  ...
  return (
    <div className="page">
      ...
      <CookieConsent />
      {/* Счётчик грузится сам, но лишь после согласия из баннера выше. */}
      <YandexMetrika />
    </div>
  );
}
