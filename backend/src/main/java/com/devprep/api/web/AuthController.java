...
public class AuthController {
    ...
    /**
     * Шаг 1 восстановления доступа: пользователь вводит адрес, на который должен уйти код.
     *
     * <p>Ответ намеренно одинаков для существующего и несуществующего адреса — 202 и маска
     * введённого адреса. Полный адрес учётки наружу не отдаётся, поэтому форма не работает как
     * справочник «есть ли такая учётка».
     */
